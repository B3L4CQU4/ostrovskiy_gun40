...
namespace CasinoGame.Core {
    public class Casino : IGame {
        ...
        private void ApplyPostGameRules() {
            ...
            // 
            // Условие из примечания:
            // Если значение банка превышает максимально возможное значения, значение банка уменьшается в два раза. 
            // При этом выводится сообщения "You wasted half of your bank money in casino's bar"
            //
            // Условие из Игрового флоу:
            // В случае, если игрок выиграл и итоговое значение банка превышает максимально 
            // допустимое значение - значение банка становится равным максимально возможному значению. 
            // При этом остаток выводится на экран вместе с сообщением, 
            // что игрок разорил казино и на его месте построят новое.
            //
            // Получается что оба условия говорят о превышении максимального банка, но предлагают разные действия
            // Поэтому реализована такая логика:
            // Если превышение максимального банка произошло меньше чем за 3 хода => ивент с разорением казино
            // Если на протяжении 3х ходов банка игрока больше половины от максимума => ивент с баром
            //  
